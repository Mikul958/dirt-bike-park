...
namespace Tests
{
    public class BookingTests
    {
        ...
        public void Can_Create_Booking()
        {
            ...
            var booking = new Booking { Id = 10, CartId = null, ParkId = 3, Date = new DateTime(3000000), NumAdults = 2, NumChildren = 1, TotalPrice = 40.00m };
        ...
        public async Task Can_Get_A_Booking_With_Valid_ParkId()
        {
            ...
            using (var context = new DatabaseContext(options))
            {
                ...
                var booking = new Booking { Id = 10, CartId = null, ParkId = 3, Date = new DateTime(1000000), NumAdults = 2, NumChildren = 1, TotalPrice = 40.00m };
       ...
       [Fact]
        ...
        public async Task Can_Get_All_Bookings()
        {
            ...
            var bookings = new List<Booking>
                {
                    new Booking { Id = 10, CartId = null, ParkId = 3, Date = new DateTime(2000000), NumAdults = 2, NumChildren = 1, TotalPrice = 40.00m },
                    new Booking {Id = 11, CartId =null, ParkId = 1, Date = new DateTime(1000000), NumAdults = 3, NumChildren = 0, TotalPrice = 45.00m}
                };
        ...
        public async Task Can_Add_Booking()
        {
            ...
            var booking = new BookingInputDTO { Date = new DateTime(2000000), NumAdults = 3, NumChildren = 0 };
        ...
        public async Task Can_Remove_Booking()
        {
            ...
            var booking = new Booking { Id = 11, CartId = null, ParkId = 1, Date = new DateTime(2000000), NumAdults = 3, NumChildren = 0, TotalPrice = 45.00m };
